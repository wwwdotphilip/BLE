...
//        mDataField.setText(R.string.no_data);
    ...
    */
    ...
    // Launch
    public void uploadFirmware(View v){
        Intent upload = new Intent(this, OTAActivity.class);
        upload.putExtra("device_address", mDeviceAddress);
        upload.putExtra("device_name", mDeviceName);
        startActivity(upload);
    }

    // Send characteristic to hub to enable OTA
    // TODO: 4/13/18 this is not working
    public void onClickOTA(View v){
        if(mBluetoothLeService != null) {
